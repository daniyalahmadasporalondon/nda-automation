...
class CheckerTests(unittest.TestCase):
    ...
    def test_all_clause_results_include_shared_structure_context(self):
        ...
        self.assertEqual(result["review_state"]["state"], "pass")
        self.assertEqual(result["review_state"]["overall_status"], result["overall_status"])
        self.assertEqual(result["review_state"]["counts"]["pass"], result["requirements_passed"])
    ...
    def test_governing_law_needs_review_for_placeholder_jurisdiction(self):
        ...
        self.assertTrue(result["review_state"]["requires_human_review"])
        ...
        self.assertEqual(governing_law["proposed_change"]["action"], "needs_human_choice")
        self.assertEqual(governing_law["proposed_change"]["evidence"]["paragraph_id"], "p5")
        self.assertEqual(governing_law["proposed_change"]["safety"]["status"], "needs_human_choice")
        self.assertTrue(governing_law["proposed_change"]["safety"]["requires_human_approval"])
    ...
    def test_unqualified_independently_develops_usage_right_needs_review(self):
        result = review_nda(
            """
            Confidential Information means any and all non-public business, financial, technical,
            customer, supplier, pricing, market, proprietary and trade secret information disclosed
        ...
        self.assertEqual(result_clause["decision"], "review")
        self.assertTrue(result_clause["needs_review"])
        self.assertEqual(result_clause["reason_code"], "usage_right_language_needs_review")
        self.assertEqual(result_clause["matched_paragraph_ids"], ["p2"])
        self.assertEqual(
            result_clause["confidential_information_analysis"]["usage_right_review_paragraph_ids"],
            ["p2"],
        )
    ...
    def test_missing_signatures_creates_insert_redline_at_end(self):
        ...
        self.assertEqual(redline["action"], "insert_after_paragraph")
        self.assertEqual(redline["paragraph_id"], "p2")
        self.assertEqual(signatures["proposed_change"]["action"], "insert")
        self.assertEqual(signatures["proposed_change"]["paragraph_id"], "p2")
        self.assertEqual(signatures["proposed_change"]["source_text"], redline["anchor_text"])
        self.assertIn("For [Party 1 legal name]", signatures["proposed_change"]["proposed_text"])
