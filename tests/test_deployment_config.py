...
class DeploymentConfigTests(unittest.TestCase):
    ...
    def test_render_blueprint_keeps_public_deploy_hardened(self):
        ...
        self.assertRegex(blueprint, r"key:\s+NDA_AI_PROVIDER\s+value:\s+alibaba")
        self.assertRegex(blueprint, r"key:\s+NDA_AI_MODEL\s+value:\s+qwen3\.5-122b-a10b")
        self.assertRegex(blueprint, r"key:\s+ALIBABA_API_KEY\s+sync:\s+false")
