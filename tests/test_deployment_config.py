...
class DeploymentConfigTests(unittest.TestCase):
    ...
    def test_render_blueprint_keeps_public_deploy_hardened(self):
        ...
        self.assertRegex(blueprint, r"key:\s+NDA_AI_MODEL\s+value:\s+google/gemini-3.5-flash")
        ...
        self.assertRegex(blueprint, r"key:\s+NDA_GMAIL_TRIAGE_MODEL\s+value:\s+google/gemini-3.5-flash")
