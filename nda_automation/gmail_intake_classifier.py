...
DEFAULT_INTAKE_PLAYBOOK = (
    "=== THE PRIMARY-PURPOSE TEST (apply this first) ===\n"
    "An NDA is a STANDALONE agreement whose ONE primary, operative purpose is to "
    "protect confidential information. The decisive question is not whether the "
    "document mentions confidentiality, and not what the filename or email subject "
    "calls it -- it is what the document's OPERATIVE obligations actually do. If you "
    "strip out the confidentiality clauses and a substantive commercial agreement "
    "still remains (services to be performed, deliverables, R&D work, a licence "
    "granted, goods supplied, employment terms, payment/fees owed), the document is "
    "NOT an NDA -- its confidentiality clause is incidental boilerplate inside a "
    "larger deal. Classify on the operative substance, never on the title alone: a "
    "file called \"NDA for review\" that is actually a consultancy or services "
    "contract is NOT_NDA.\n"
    ...
    "information AND it imposes essentially no other substantive commercial "
    "obligation. This includes a mutual or one-way NDA/MNDA, a confidential "
    ...
    "obligations. Such a document is dominated by definitions of Confidential "
    "Information, permitted-use / non-disclosure / return-or-destroy obligations, and "
    "standard carve-outs -- with no services, deliverables, fees, licence grant, or "
    "employment terms as its main subject.\n"
    "=== WHAT TO EXCLUDE ===\n"
    "Label NOT_NDA when the attachment's primary purpose is something other than "
    "confidentiality, even if it contains a confidentiality clause (and even if it is "
    "titled, filed, or emailed as an \"NDA\"). This includes a consultancy or "
    "consulting agreement, services or professional-services agreement, master "
    "services agreement (MSA), statement of work (SOW), research-and-development "
    "(R&D), collaboration, or joint-development agreement, offer or employment "
    "letter or contract, SaaS or subscription agreement, software or other licensing "
    "agreement, reseller or distribution agreement, supply or purchase agreement, "
    "loan or investment agreement, invoice, purchase order, pricing sheet, project "
    "proposal or statement, or any commercial contract whose main body governs the "
    "performance of work, the supply of goods or services, the grant of rights, or "
    "the payment of money and only has confidentiality language as one supporting "
    "clause among many. Regulatory or sector framing (e.g. HMRC / AML / tax / "
    "professional-services obligations) is a strong signal the document is a "
    "commercial services contract, not a bare NDA.\n"
    "=== UNCERTAIN ===\n"
    "Label UNCERTAIN when the attachment text is missing or truncated so you cannot "
    "apply the primary-purpose test, or when the document is a genuine co-equal "
    "hybrid where confidentiality and another operative purpose carry roughly equal "
    "weight. Prefer UNCERTAIN over a confident NDA or NOT_NDA whenever you cannot "
    "clearly tell which purpose dominates -- a doc routed to UNCERTAIN gets human "
    "counsel review, so it is the safe choice for genuine ambiguity.\n"
    "=== WORKED EXAMPLE ===\n"
    "A document titled \"NDA\" or \"NDA for review\" that, on reading, sets out R&D "
    "or consultancy services to be performed, deliverables or work product, fees, "
    "and sector/regulatory obligations (e.g. HMRC AML), with confidentiality as just "
    "one of its clauses -> NOT_NDA. The title says NDA but the operative substance is "
    "a services/R&D agreement."
)
