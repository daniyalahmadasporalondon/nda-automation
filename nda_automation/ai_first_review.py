...
def _clause_result_from_assessment(
    ...
    if assessment is None:
        assessment = {
            ...
            "why_it_might_be_a_problem": "The system does not have an AI verdict for this playbook clause.",
    ...
    result: ClauseResult = {
        ...
        "why_it_might_be_a_problem": str(assessment.get("why_it_might_be_a_problem") or "").strip(),
        "why_it_may_be_fine": str(assessment.get("why_it_may_be_fine") or "").strip(),
